# Install script for directory: /home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xrabbitmq-c-runtimex" OR NOT CMAKE_INSTALL_COMPONENT)
  foreach(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so.0.16.0"
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-build/librabbitmq/librabbitmq.so.0.16.0"
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-build/librabbitmq/librabbitmq.so.4"
    )
  foreach(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so.0.16.0"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so.4"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xrabbitmq-c-developmentx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-build/librabbitmq/librabbitmq.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librabbitmq.so"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xrabbitmq-c-developmentx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE STATIC_LIBRARY FILES "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-build/librabbitmq/librabbitmq.a")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xrabbitmq-c-developmentx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include" TYPE FILE FILES
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq/../include/amqp.h"
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq/../include/amqp_framing.h"
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq/../include/amqp_tcp_socket.h"
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq/../include/amqp_ssl_socket.h"
    )
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xrabbitmq-c-developmentx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/rabbitmq-c" TYPE FILE FILES
    ...
    "/home/louie/ingestion/ddes-smart-meter-app/ingestion/_deps/rabbitmq-c-src/librabbitmq/../include/rabbitmq-c/ssl_socket.h"
