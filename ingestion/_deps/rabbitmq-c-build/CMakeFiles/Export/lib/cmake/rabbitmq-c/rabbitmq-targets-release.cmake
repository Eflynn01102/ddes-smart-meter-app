...
set_target_properties(rabbitmq::rabbitmq PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librabbitmq.so.0.16.0"
  IMPORTED_SONAME_RELEASE "librabbitmq.so.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS rabbitmq::rabbitmq )
list(APPEND _IMPORT_CHECK_FILES_FOR_rabbitmq::rabbitmq "${_IMPORT_PREFIX}/lib/librabbitmq.so.0.16.0" )
